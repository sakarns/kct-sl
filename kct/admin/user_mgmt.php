...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
      ...
      $err["username_err"]= "Username can only contain letters, numbers, 
        and underscores.";
    ...
    if(empty(trim($_POST["password"]))){
      ...
      $err['password_err'] = "Password must have atleast 6 characters.";
    } else{
    ...
    if(empty($_POST['email'])){
     ...
     if(count($err) == 0){ 
        ...
        if(isset($_POST['hdnId']))
          ...
          ,password='".$password."' WHERE id='".$_POST['hdnId']."'";   
        else          
                        ...
                        if(mysqli_num_rows($result) > 0){
                            while ($row = mysqli_fetch_array($result)){ 
                              ...
                              "<tr>
                                  ...
                                  <td style='text-align:center'>
                                  <a  href='employee_profile.php' data-user='".$row['username']."' 
                                  data-id='".$row['id']."' id='goToPrifile' >
